...
class TheatresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theatre" do
    assert_difference('Theatre.count') do
      post theatres_url, params: { theatre: { place: @theatre.place, t_name: @theatre.t_name } }
    end
  ...
  test "should update theatre" do
    patch theatre_url(@theatre), params: { theatre: { place: @theatre.place, t_name: @theatre.t_name } }
